...
class MOSearchServiceStub implements MassOutbreakSearcher {
  ...
  Future<MassOutbreakInformation> gatherOutbreakInformation() async {
    return MassOutbreakInformation("DA4676C773234F", 10, 25);
  }

  @override
  Future<SearchResult> performSearch(MassOutbreakInformation moInfo, MassOutbreakSearchData filters, int rolls, bool multimatch, void Function(MassOutbreakResult? p1) onMatch, Function onTick) async {

...
List<int> _dexOrder = [1, 201, 442, 722, 723, 724, 155, 156, 157, 501, 502, 503, 399, 400, 396, 397, 398, 403, 404, 405, 265, 266, 267, 268, 269, 77, 78, 133, 41, 42, 169, 425, 426, 401, 402, 418, 419, 74, 75, 76, 234, 899, 446, 143, 46, 47, 172, 25, 26, 63, 64, 65, 390, 391, 392, 427, 428, 420, 54, 55, 415, 123, 900, 214, 439, 122, 190, 424, 129, 130, 422, 423, 211, 904, 440, 113, 242, 406, 315, 407, 455, 548, 549, 114, 465, 339, 340, 453, 454, 280, 281, 282, 475, 193, 469, 449, 450, 417, 434, 435, 216, 217, 901, 704, 705, 706, 95, 208, 111, 112, 464, 438, 185, 108, 463, 175, 176, 468, 387, 388, 389, 92, 93, 94, 442, 198, 430, 201, 363, 364, 365, 223, 224, 451, 452, 58, 59, 431, 432, 66, 67, 68, 441, 355, 356, 477, 393, 394, 395, 458, 226, 550, 902, 37, 38, 72, 73, 456, 457, 240, 126, 467, 436, 437, 239, 125, 466, 207, 472, 443, 444, 445, 299, 476, 100, 101, 479, 433, 358, 200, 429, 173, 35, 36, 215, 903, 361, 362, 478, 220, 221, 473, 712, 713, 459, 460, 570, 571, 627, 628, 447, 448];

extension PokdexOrders on Iterable<PokedexEntry> {
  List<PokedexEntry> dexOrder() {
    return toList()..sort((a, b) => _dexOrder.indexOf(a.nationalDexNumber).compareTo(_dexOrder.indexOf(b.nationalDexNumber)));
  }
}
